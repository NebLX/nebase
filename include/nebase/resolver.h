 ...
 */
extern int neb_resolver_set_bind_ip(neb_resolver_t r, const struct sockaddr *addr)
 ...
 * \param[in] addr port is not used, only family and addr should be set
 */
extern int neb_resolver_ctx_gethostbyaddr(neb_resolver_ctx_t c, const struct sockaddr *addr, ares_host_callback cb)
