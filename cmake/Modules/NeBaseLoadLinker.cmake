...
macro(_NebLoadLinker_get_linker_info _LINKER_VERSION_STRING)
...
endmacro(_NebLoadLinker_get_linker_info)

macro(_NebLoadLinker_export_var _var)
  set(${_var} ${${_var}} PARENT_SCOPE)
endmacro(_NebLoadLinker_export_var)

function(_NebLoadLinker_detect_linker_id)
  ...
  if(NOT $ENV{CFLAGS} STREQUAL "")
    ...
    if(CFLAGS_USE_LDS)
      ...
      if(NOT NeBase_LINKER_ID STREQUAL "")
        ...
        _NebLoadLinker_export_var(NeBase_LINKER_ID)
        return()
      endif()
    endif()
  endif()
  ...
  if(LD_VERSION_RESULT EQUAL 0)
    ...
    _NebLoadLinker_get_linker_info("${LD_VERSION_STRING}")
    message(STATUS "The linker is ${NeBase_LINKER_ID} version ${NeBase_LINKER_VERSION}")
    _NebLoadLinker_export_var(NeBase_LINKER_ID)
    _NebLoadLinker_export_var(NeBase_LINKER_VERSION)
    return()
  endif()

  message(FATAL_ERROR "Failed to get linker version info")
endfunction(_NebLoadLinker_detect_linker_id)

_NebLoadLinker_detect_linker_id()
...
if(NeBase_CC_USE_WL)
  if(WITH_HARDEN_FLAGS)
    ...
    foreach(HARDEN_FLAG IN LISTS LD_HARDEN_LIST)
      set(NeBase_LD_HARDEN_FLAGS "${NeBase_LD_HARDEN_FLAGS} -Wl,-z,${HARDEN_FLAG}")
    endforeach()
  endif()
else()
  if(WITH_HARDEN_FLAGS)
    ...
    foreach(HARDEN_FLAG IN LISTS LD_HARDEN_LIST)
      set(NeBase_LD_HARDEN_FLAGS "${NeBase_LD_HARDEN_FLAGS} -z ${HARDEN_FLAG}")
    endforeach()
  endif()
endif()
