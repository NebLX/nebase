...
if(CMAKE_C_COMPILER_ID STREQUAL "GNU")
  ...
  if(WITH_HARDEN_FLAGS)
    set(NeBase_C_FLAGS "${NeBase_C_FLAGS} -fstack-protector-strong")
    set(NeBase_C_FLAGS "${NeBase_C_FLAGS} -D_FORTIFY_SOURCE=2")
  endif()
...
elseif(CMAKE_C_COMPILER_ID STREQUAL "SunPro")
  ...
  if(WITH_HARDEN_FLAGS)
    if(OS_SOLARIS) # stack overflow support only on Solaris
      set(NeBase_C_FLAGS "${NeBase_C_FLAGS} -xcheck=stkovf")
    endif()
  endif()
...
elseif(CMAKE_C_COMPILER_ID STREQUAL "XL")
  ...
  if(WITH_HARDEN_FLAGS)
    set(NeBase_C_FLAGS "${NeBase_C_FLAGS} -qstackprotect=strong")
    set(NeBase_C_FLAGS "${NeBase_C_FLAGS} -D_FORTIFY_SOURCE=2")
  endif()
