...
elseif(OS_DFLYBSD)
  set(_NebInstallDirs_DEFAULT_INSTALL_PREFIX "/usr/local")
elseif(OS_DARWIN)
  # use the default install path for Homebrew
  set(_NebInstallDirs_DEFAULT_INSTALL_PREFIX "/usr/local")
elseif(OSTYPE_SUN)
  set(_NebInstallDirs_DEFAULT_INSTALL_PREFIX "/usr")
elseif(OS_HAIKU)
...
if(CMAKE_CROSSCOMPILING)
  if(CMAKE_SYSROOT AND "$ENV{PKG_CONFIG_SYSROOT_DIR}" STREQUAL "")
    set(ENV{PKG_CONFIG_SYSROOT_DIR} "${CMAKE_SYSROOT}")
  endif()

  if(NOT "$ENV{PKG_CONFIG_PATH}" STREQUAL "")
    set(ENV{PKG_CONFIG_PATH} "$ENV{PKG_CONFIG_PATH}:${CMAKE_INSTALL_FULL_LIBDIR}/pkgconfig")
  else()
    set(ENV{PKG_CONFIG_PATH} "${CMAKE_INSTALL_FULL_LIBDIR}/pkgconfig")
  endif()
